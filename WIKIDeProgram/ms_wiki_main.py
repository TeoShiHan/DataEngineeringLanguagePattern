...
if __name__ == "__main__":
    ...
    bi = spark.read.text(data_path).sample(0.001)
    ...
    plt.savefig('visualization/top10msWIKIPOSPattern', dpi=300, bbox_inches='tight')
    ################################################################################################################
    ## Analytics
    ...
    plt.savefig('visualization/top10msWIKITokenPattern', dpi=300, bbox_inches='tight')
